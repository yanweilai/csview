...
export default {
  ...
  children: [
    ...
    },
    {
      ...
      component: () =>
        import("@/pages/marketing/storeIntegral/addStoreIntegral"),
    },
    {
    ...
    {
      path: "coupon_model/index",
      name: `${pre}modelCoupon`,
      meta: {
        auth: ["marketing-model_coupon"],
        title: "自提劵模板",
      },
      component: () => import("@/pages/marketing/modelCoupon/index"),
    },
    {
      path: "coupon_model/create/:id?",
      name: `${pre}modelCouponCreate`,
      meta: {
        auth: ["admin-marketing-model_coupon_issue-create"],
        title: "添加自提劵",
      },
      component: () => import("@/pages/marketing/modelCoupon/create"),
    },
    {
      path: "model_coupon_issue/index",
      name: `${pre}modelCouponIssue`,
      meta: {
        auth: ["marketing-model_coupon_issue"],
        title: "自提劵列表",
      },
      component: () => import("@/pages/marketing/modelCouponIssue/index"),
    },
    {
      path: "model_coupon_prefix/index",
      name: `${pre}modelCouponPrefix`,
      meta: {
        auth: ["marketing-model_coupon_prefix"],
        title: "前缀列表",
      },
      component: () => import("@/pages/marketing/modelCouponPrefix/index"),
    },
    {
      path: "model_coupon_prefix/create/:id?",
      name: `${pre}modelCouponPrefixCreate`,
      meta: {
        auth: ["admin-marketing-model_coupon_prefix-create"],
        title: "添加前缀",
      },
      component: () => import("@/pages/marketing/modelCouponPrefix/create"),
    },
  ],
};
