...
//   process.env.VUE_APP_API_URL || `${location.origin}/adminapi`;
// // 管理端ws
// const VUE_APP_WS_ADMIN_URL =
//   process.env.VUE_APP_WS_ADMIN_URL || `ws:${location.hostname}/ws`;
...
const Setting = {
  ...
  routePreKF,
  // 网页标题的后缀
  titleSuffix: util.cookies.get("pageTitle") || "JL",
