    ...
    <Card :bordered="false" dis-hover class="ivu-mt">
      ...
      >
        <Row
          type="flex"
          :gutter="24"
          v-if="$route.path === '/setting/sms/sms_template_apply/index'"
        >
          <!-- <Col v-bind="grid">
                        <FormItem label="模板类型：">
      ...
      >
        ...
        <template
          ...
          slot="is_have"
          v-if="$route.path === '/setting/sms/sms_template_apply/commons'"
        >
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      let data = {
        data:
          this.$route.path === "/setting/sms/sms_template_apply/index"
            ? this.levelFrom
            : this.levelFrom2,
        url:
          this.$route.path === "/setting/sms/sms_template_apply/index"
      ...
      if (
        this.$route.path === "/setting/sms/sms_template_apply/commons"
      ) {
