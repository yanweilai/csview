    ...
    <div class="order-details pos-order-details" v-if="orderInfo">
        ...
        <div class="wrapper">
            ...
            <div class="item acea-row row-between" v-if="orderInfo.use_integral > 0">
                <div>积分抵扣：</div>
                <div class="conter">-￥{{parseFloat(orderInfo.deduction_price).toFixed(2)}}</div>
            </div>
        ...
        >
            ...
            <router-link
                    ...
                    :to="{path:`${routePreKF}/orderDelivery/${orderInfo.id}/${orderInfo.order_id}`,query: {productType: orderInfo.product_type}}"
            >去发货
            </router-link
            >
        </div>
