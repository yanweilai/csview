<template>
  <Drawer :value="visible" :closable="true" :styles="{ padding: '0 0 60px' }" width="1000"
    ...
    <Tabs v-model="currentTab">
      <TabPane v-for="item in headTab" :key="item.name" :label="item.title" :name="item.name">
      </TabPane>
    </Tabs>
    ...
    <!-- 商品标签 -->
    <Modal v-model="storeLabelShow" scrollable title="请选择商品标签" :closable="false" width="320" :footer-hide="true"
           :mask-closable="false">
