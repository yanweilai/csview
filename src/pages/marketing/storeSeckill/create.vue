    ...
    <div class="form-submit">
        <div class="i-layout-page-header">
            <PageHeader class="product_tabs" hidden-breadcrumb>
                <div slot="title">
                    <router-link :to="{ path: `${roterPre}/marketing/store_seckill/index` }">
...
export default {
    ...
    methods: {
        ...
        next(name) {
                ...
                this.$refs[name].validate((valid) => {
                    if (valid) {
                        ...
                        seckillAddApi(this.formValidate).then(async res => {
                            ...
                            setTimeout(() => {
                                this.$router.push({ path: this.roterPre + '/marketing/store_seckill/index' });
                            }, 500);
                        }).catch(res => {
                            this.submitOpen = false;
                            this.$Message.error(res.msg);
            ...
            //                 this.$Message.success(res.msg);
            //                 setTimeout(() => {
            //                     this.$router.push({ path: '/marketing/store_seckill/index' });
            //                 }, 500);
            //             }).catch(res => {
            //                 this.submitOpen = false;
            //                 this.$Message.error(res.msg);
