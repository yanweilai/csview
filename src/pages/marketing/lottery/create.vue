              ...
              <!--   <Col span="24">
                <FormItem label="活动类型：" prop="factor" label-for="factor">
                  <RadioGroup element-id="factor" v-model="formValidate.factor">
                    <Radio :label="1" class="radio">积分抽奖</Radio>
              ...
              <Col span="24">
                ...
                <FormItem>
                  <div class="pl60 grey">
                    ...
                    <Poptip placement="bottom" trigger="hover" width="380" transfer padding="8px">
                      <a>查看位置示例图</a>
                ...
                >
                  ...
                  <Poptip placement="bottom" trigger="hover" width="256" transfer padding="8px">
                    ...
                    <div class="exampleImg" slot="content">
                      <img
                        :src="`${baseURL}/statics/system/luck.png`"
                        alt=""
                      />
                    </div>
                  </Poptip>
