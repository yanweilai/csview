  ...
  <div class="form-submit">
    <div class="i-layout-page-header">
      <PageHeader class="product_tabs" hidden-breadcrumb>
        <div slot="title">
          <router-link :to="{ path: `${roterPre}/marketing/discount/give` }"
          >
            ...
            <FormItem label="">
              <div class="list">
                <div class="item" v-for="(item,indexw) in promotionsData" :key="indexw">
                  ...
                  <FormItem label="优惠内容：">
                    <Checkbox v-model="item.checkIntegral">送</Checkbox><InputNumber :max="999999" :min="0" :precision="0" v-model="item.give_integral" class="width23"></InputNumber><span class="ml10">积分</span>
                  </FormItem>
                  <div class="ml90">
