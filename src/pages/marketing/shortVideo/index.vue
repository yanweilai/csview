...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            changeMenu(row, name, index) {
                switch (name) {
                    case "2":
                        ...
                        break;
                    case "3":
                        this.$router.push({ path: this.roterPre + "/marketing/short_video/comment",query:{'id':row.id} });
                        break;
                    case "4":
            ...
            // 添加
            add() {
                this.$router.push({ path: `${this.roterPre}/marketing/short_video/create` });
            },
            // 列表
            getList() {
                this.loading = true;
            ...
            edit(row) {
                this.$router.push({
                    path: this.roterPre + "/marketing/short_video/create/" + row.id
                });
            },
            // 删除
            del(row, tit, num) {
