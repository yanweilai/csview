  ...
  <div>
      ...
      <div v-if="orderDatalist">
          ...
          <div class="full">
            ...
            <div v-if="rowActive.delete_time == null">
              ...
              <!-- <Button
                ...
                "
                @click="changeMenu('5')"
                >{{ orderData.refund_type == 2 ? '同意退货' : '立即退款' }}
              </Button> -->
              <!-- <Button
                :class="openErp ? 'on' : ''"
                :disabled="openErp"
                v-if="[1, 2].includes(orderData.refund_type)"
                @click="changeMenu('7')"
                >不退款
              </Button> -->
        ...
        <Tabs v-model="activeName">
          <TabPane label="订单信息" name="detail">
            ...
            <div
              v-if="orderDatalist.orderInfo.custom_form.length && isShow"
              class="section"
            >
              ...
              <template slot-scope="{ row }" slot="product">
                <Tooltip theme="dark" max-width="300" :delay="600">
                  <div class="product">
                    ...
                    <div class="title">
                      <div class="line2">
                        <span class="font-color-red" v-if="row.is_gift">[赠品]</span>{{ row.productInfo.store_name }} | {{row.productInfo.attrInfo ? row.productInfo.attrInfo.suk : ''}}
                      </div>
                    </div>
                  </div>
                  <div slot="content">
          ...
          <TabPane label="发货记录" name="recordList">
            <Table
              :columns="columnSplit"
              :data="splitList"
              :loading="loading"
            ...
            >
              ...
              <template slot-scope="{ row }" slot="deliveryInfo">
                ...
                <div v-if="row.delivery_name">
                  配 &nbsp;送 &nbsp;人：{{ row.delivery_name }}
                </div>
                <div v-if="row.delivery_id" @click="openItemLogistics(row)">
              ...
              <template slot-scope="{ row, index }" slot="action">
                ...
                <a
                  ...
                  >配送信息</a
                > -->
                <a :disabled="openErp" @click="changeMenu('3', row)"
                  >订单记录</a
                >
    ...
    >
      <div
        ...
        v-if="orderDatalist || logisticsCon"
      >
...
<script>
import { splitOrder, getOrderRecord } from '@/api/supplier'
...
export default {
  ...
  data() {
    return {
      ...
      modal2: false,
      isShow: 0,
      img: 'https://test.pro.wuht.net/uploads/attach/2022/04/18/11ea015ba627836f564c667c1d53fe2a.jpg',
      modal2: false,
      modals: false,
      grid: {
        xl: 8,
