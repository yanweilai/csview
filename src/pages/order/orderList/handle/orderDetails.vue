      ...
      <div v-if="orderDatalist">
          ...
          <div class="full">
            ...
            <div v-if="rowActive.delete_time == null">
              ...
              <Button
                :class="openErp ? 'on' : ''"
                :disabled="openErp"
                v-if="orderData._status_new === 4 && !rowActive.split.length"
                @click="delivery"
              >
                配送信息
              </Button>
              ...
              <Button
                :class="openErp ? 'on' : ''"
                :disabled="openErp"
                v-if="[1, 2, 5].includes(orderData.refund_type)"
                @click="changeMenu('7')"
                >不退款
              </Button>
        ...
        <Tabs v-model="activeName">
          <TabPane label="订单信息" name="detail">
            ...
            <div
              class="section"
              v-if="orderDatalist.orderInfo.supplierInfo"
            >
                  ...
                  <div class="product">
                    ...
                    <div class="title">
                      <div class="line2">
                        ...
                        {{ row.productInfo.store_name }} | {{ row.productInfo.attrInfo ? row.productInfo.attrInfo.suk : '' }}
                      </div>
                    </div>
                  </div>
                  <div slot="content">
            ...
            >
              ...
              <template slot-scope="{ row, index }" slot="action">
                ...
                <a
                  :disabled="openErp"
                  @click="btnClick(row)"
                  v-if="row.supplier_name && row.status_name.status_name == '未发货'"
                  >提醒发货</a
                >
