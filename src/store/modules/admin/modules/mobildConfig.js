  ...
  state: {
    ...
    pageFooter: {
      ...
      menuList: [
        {
          imgList: [
            require("@/assets/images/foot-001.png"),
            require("@/assets/images/foot-002.png"),
          ],
          name: "首页",
        ...
        {
          imgList: [
            require("@/assets/images/foot-003.png"),
            require("@/assets/images/foot-004.png"),
          ],
          name: "分类",
        ...
        {
          imgList: [
            require("@/assets/images/foot-007.png"),
            require("@/assets/images/foot-008.png"),
          ],
          name: "我的",
  ...
  mutations: {
    ...
    defaultArraySort(state, data) {
      ...
      if (data.oldIndex != undefined) {
        sortArr = JSON.parse(
          JSON.stringify(swapArray(newArr, data.newIndex, data.oldIndex))
        );
      } else {
