<template>
    <div class="i-layout-menu-head" :class="{ 'i-layout-menu-head-mobile': isMobile }">
      <Tabs v-if="!isMobile && !isMenuLimit" :value="headerName" :animated="false" @on-click="tabClick">
        <TabPane v-for="item in filterHeader" :key="item.header" :label="item.title" :name="item.header"></TabPane>
      </Tabs>
