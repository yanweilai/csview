...
import { seckillListApi, combinationListApi, bargainListApi, integralProductListApi } from '@/api/marketing';
...
export default {
  ...
  methods: {
    ...
    handleLoadData(item, callback) {
      item._loading = true;
      pageLink(this.categoryId, item.id).then(res => {
        item._loading = false;
